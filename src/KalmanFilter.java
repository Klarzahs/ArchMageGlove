...
public class KalmanFilter {
	...
	private float gyroMeasError = 3.14159265358979f * (5.0f / 180.0f);
	private float beta = (float) (Math.sqrt(3.0f / 4.0f) * gyroMeasError);
	
	// Global system variables
	float SEq_1 = 1.0f, SEq_2 = 0.0f, SEq_3 = 0.0f, SEq_4 = 0.0f; // estimated orientation quaternion elements with initial conditions
	
	
	public void filterUpdate(float w_x, float w_y, float w_z, float a_x, float a_y, float a_z, float deltat){
